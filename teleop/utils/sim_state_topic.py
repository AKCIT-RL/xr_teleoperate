...
class SimStateSubscriber:
    ...
    def __init__(self, shm_name: str = "sim_state_cmd_data", shm_size: int = 16384):
...
def start_sim_state_subscribe(shm_name: str = "sim_state_cmd_data", shm_size: int = 16384) -> SimStateSubscriber:
